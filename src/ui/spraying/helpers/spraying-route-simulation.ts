...
export const SPRAYING_SIMULATION_LOCATION_INTERVAL_MS = 250;
...
function buildSimulationRouteSegment(start: LatLng, end: LatLng) {
...
export function createSprayingSimulationLocation(
  coordinate: LatLng,
