-- Altera a RPC sync_reviewed_spraying_operation para pular plantas
-- marcadas como is_dead ou non_existent ao invés de abortar toda a operação.
-- Isso resolve o cenário onde o cache local do mobile está desatualizado
-- e envia plantas que foram marcadas como indisponíveis no servidor
-- entre o carregamento do cache e o momento do sync.
